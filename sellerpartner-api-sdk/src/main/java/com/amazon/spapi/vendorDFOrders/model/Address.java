...
public class Address {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the person, business or institution at that address. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
   ...
   * @return attention
  **/
  @ApiModelProperty(value = "The attention name of the person at that address. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
   ...
   * @return addressLine1
  **/
  @ApiModelProperty(required = true, value = "First line of the address. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
   ...
   * @return addressLine2
  **/
  @ApiModelProperty(value = "Additional address information, if required. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
  ...
  **/
   ...
   * @return city
  **/
  @ApiModelProperty(value = "The city where the person, business or institution is located. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
   ...
   * @return county
  **/
  @ApiModelProperty(value = "The county where person, business or institution is located. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
   ...
   * @return district
  **/
  @ApiModelProperty(value = "The district where person, business or institution is located. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
  ...
  **/
   ...
   * @return phone
  **/
  @ApiModelProperty(value = "The phone number of the person, business or institution located at that address. For Amazon label only vendors, this field will have the value `xxxxx` within the object `shipToParty`.")
