...
public class VendorOrdersApi {
     ...
     */
    public com.squareup.okhttp.Call getOrderCall(String purchaseOrderNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
    ...
    private com.squareup.okhttp.Call getOrderValidateBeforeCall(String purchaseOrderNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetOrderResponse getOrder(String purchaseOrderNumber) throws ApiException,LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetOrderResponse> getOrderWithHttpInfo(String purchaseOrderNumber) throws ApiException,LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderAsync(String purchaseOrderNumber, final ApiCallback<GetOrderResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetOrdersResponse getOrders(OffsetDateTime createdAfter, OffsetDateTime createdBefore, String shipFromPartyId, String status, Long limit, String sortOrder, String nextToken, String includeDetails) throws ApiException,LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetOrdersResponse> getOrdersWithHttpInfo(OffsetDateTime createdAfter, OffsetDateTime createdBefore, String shipFromPartyId, String status, Long limit, String sortOrder, String nextToken, String includeDetails) throws ApiException,LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrdersAsync(OffsetDateTime createdAfter, OffsetDateTime createdBefore, String shipFromPartyId, String status, Long limit, String sortOrder, String nextToken, String includeDetails, final ApiCallback<GetOrdersResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call submitAcknowledgementCall(SubmitAcknowledgementRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call submitAcknowledgementValidateBeforeCall(SubmitAcknowledgementRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call submitAcknowledgementAsync(SubmitAcknowledgementRequest body, final ApiCallback<SubmitAcknowledgementResponse> callback) throws ApiException, LWAException {
